...
# BASE_URL = "https://imdgeospatial.imd.gov.in/Min_Temperature/"

# FILES = {
#     "station": BASE_URL + "data/StationData_11.js"
# }
...
#     # Extract JSON from JS (remove "var json_... =")
...
#             "max_temp_prev": props.get("Previous_Day_Max_temp"),
#             "max_departure": props.get("Previous_Day_Max_Departure_from_Normal"),
#             "min_temp_today": props.get("Today_Min_temp"),
#             "min_departure": props.get("Today_Min_Departure_from_Normal"),
#             "humidity": props.get("Previous_Day_Relative_Humidity_at_1730"),
#             "lat": lat,
#             "lon": lon
#         }
...
#     data = fetch_js_data(FILES["station"])
#     df = geojson_to_df(data)

#     print(df.head())

#     # Save to CSV
#     df.to_csv("imd_temperature_data.csv", index=False)
#     print("✅ Data saved to imd_temperature_data.csv")
